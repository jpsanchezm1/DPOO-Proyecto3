...
public class ControladorPagos {
	...
	private String archivoPagosReservas = "./data/consumos/pagosReservas.txt";

	public ControladorPagos() throws IOException {
		recuperarInformacion();
	}

	public void pagarConsumo(String ide, String referencia, String precio) {
		...
		String infoPago = id.toString() + ";" + referencia + ";" + tiempoActual.toString() + ";" + precio;
		editorPagos.registarPago(archivoPagos, infoPago);
	}

	public void pagarReserva(String ide, String referencia, String precio) {
		LocalTime tiempoActual = LocalTime.now();
		Integer id = Integer.parseInt(ide);
		Pago pago = new Pago(id, referencia, tiempoActual);
